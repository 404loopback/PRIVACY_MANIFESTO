...
Cette disproportion implique un autre moteur: **l'investissement**.
Quand une plateforme lève massivement des fonds, elle hérite d'une contrainte structurelle: **produire du rendement**.

Chez [Nick Srnicek](https://politybooks.com/bookdetail?book_slug=platform-capitalism--9780745699551), l'idée centrale est que la logique des plateformes est souvent séquentielle:
...
Les travaux présentés notamment à [ACL](https://aclanthology.org/) et [NeurIPS](https://neurips.cc/) montrent la valeur des données conversationnelles réelles:
...
- accumule des données à grande échelle
- dépend de capitaux externes
- conserve des utilisateurs captifs
...
Alternatives imparfaites, mais structurantes:
...
- [Revolt](https://revolt.chat/) pour une approche open source proche de Discord
